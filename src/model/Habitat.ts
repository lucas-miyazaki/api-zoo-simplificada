                        ...
                        await database.query(queryDeleteAtracao)
                            .then(async (result) => {
                                if (result.rowCount !== 0) {
                                    ...
                                    const deleteHabitatResult = await database.query(queryDeleteHabitat);

                                    if (deleteHabitatResult.rowCount !== 0) {
                                        console.log(`${deleteHabitatResult.rowCount} registro de habitat excluído para o idHabitat ${idHabitat}`);
                                        queryResult = true;
                                    } else {
